...
//    }
//
//    private boolean canMoveDFBnB(int i, int j, Marble[][] board) {
//        if (!board[i][j].getColor().equals("_")) {
...
//        }
//        Position lastPos = pathDid.getLast(); // Last position in the path
...
//    }
//
//    public boolean[] allowedOperatorsDFBnB(Marble[][] board) {
//        boolean[] allowed = new boolean[4]; // [up, down, left, right]
//        int i = this.pos.getI();
//        int j = this.pos.getJ();
//
//        if (!board[i][j].getColor().equals("R") || !board[i][j].getColor().equals("G") || !board[i][j].getColor().equals("B")) {
